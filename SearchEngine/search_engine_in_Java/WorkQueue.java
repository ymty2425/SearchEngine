...
public class WorkQueue {
	...
	public void finish() {
		synchronized (this) {
			try {
				...
				System.out.println("Workqueue had an exception while running.");
			}
		}
	}

	/**
	 * Increment the number of pending workers.
	 */
	...
	/**
	 * Decrement the number of pending workers.
	 */
